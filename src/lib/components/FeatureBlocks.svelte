...
<section id="excels-section" class="py-20 border-b-2 border-navy bg-cream">
	<div class="container-custom">
		<div class={[
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
			{#each excelsItems as item, index}
				<div class={[
					'group bg-background border-2 border-navy p-8 space-y-3 transition-all duration-700',
